...
public class Calculator {
	...
	private JButton btnC, btnBack, btnMod, btnDiv, btn7, btn8, btn9, btnMul, btn4, btn5, btn6, btnSub, btn1, btn2,
			btn3, btnAdd, btnPoint, btn0, btnEqual, choixColor;
	...
	/*
	 * Mx Calculator: X = Ligne Y = Column
	 * 
	 * +-------------------+ | +-----------+ | y[0] | | | | | +-----------+ | | | |
	 * C <- % / | y[1] | 7 8 9 * | y[2] | 4 5 6 - | y[3] | 1 2 3 + | y[4] | . 0 = |
	 * y[5] +-------------------+ x[0] x[1] x[2] x[3]
	 * 
	 */
	...
	/*
	 * +-------------------+ | +-----------+ | y[0] | | | | | +-----------+ | | | |
	 * 0 1 1 3 | y[1] | 4 5 6 7 | y[2] | 8 9 10 11 | y[3] | 12 13 14 15 | y[4] | 16
	 * 17 18 | y[5] +-------------------+ x[0] x[1] x[2] x[3]
	 * 
	 */

	private Calculator() {// end:456
		...
		window.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // If Click into The Red Button => End The
									// Process
